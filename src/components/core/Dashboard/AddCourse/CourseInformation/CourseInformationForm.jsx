...
const CourseInformationForm = () => {
    ...
    const onSubmit =async(data) =>{
      if(editCourse){
        ...
        if(currentValues.courseBenefits !== course.courseWhatYouWillLearn){
    ...
    className='rounded-md border-richblue-700 bg-richblue-800 p-6 space-y-8'>
      ...
      <div className='relative'>
        ...
        <input 
          ...
          className='w-full'/>
          <HiOutlineCurrencyRupee className='absolute top-1/2 text-richblue-400'/>
          {
            errors.coursePrice && (
          ...
          <div>
            {
              editCourse && (
                ...
                className='flex items-center gap-x-2 bg-richblue-300'
                >
